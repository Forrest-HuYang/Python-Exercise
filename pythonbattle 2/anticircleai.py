...
class AI:
    ...
    def turn(self):
        if self.robot.lookInFront() == "bot":
            ...
            self.robot.turnRight()
            self.currentlyDoing = "return"
        elif self.currentlyDoing == "return":
            self.robot.goForth()
            self.currentlyDoing = "rotate1"
        elif self.currentlyDoing == "rotate1":
            self.robot.turnRight()
            self.currentlyDoing = "rotate2"
        elif self.currentlyDoing == "rotate2":
